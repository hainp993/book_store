            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="full_name" class="col-md-4 col-form-label text-md-end">{{ __('Họ và tên') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="date-of-bith" class="col-md-4 col-form-label text-md-end">{{ __('Ngày sinh') }}</label>

                            <div class="col-md-6">
                                <input id="date-of-bith" type="date" class="form-control" name="date_of_bith">
                            </div>
                        </div>
